...
import 'package:momly_app/book_appointment_screens/make_payment_screen.dart';
import 'package:momly_app/book_appointment_screens/widgets/Widgets.dart';


class book_appointment_screen_2 extends StatelessWidget {
  const book_appointment_screen_2({Key? key}) : super(key: key);
                                      ...
                                      child: Container(
                                        ...
                                        child: Center(
                                          child: Row(
                                             crossAxisAlignment: CrossAxisAlignment.center,
                                            children: [
                                              Image.asset('images/Avatagirllr.png'),
                                              SizedBox(width: 5,),
                                              Column(
                                                crossAxisAlignment: CrossAxisAlignment.center,
