                             ...
                             Container(
                               ...
                               child: Column(
                                 children: [
                                     ...
                                     children: [
                                       ...
                                       InkWell(
                                         ...
                                         child: Container(
                                           ...
                                           child:  Image.asset('images/Bar Chart Up With Border.png'),
                                         ),
                                       ),
                                     ],
                                   ),
                                   ...
                                   widgets_appointmentscreen().speciality(null,'Choose a speciality','Choose a speciality', Icon(Icons.favorite_border_rounded,color: Colors.black,),),
                                   SizedBox(
                                     height: 10,
                                   ),
                                   Row(
                                     ...
                                     child: Container(
                                       ...
                                       child: TextField(
                                         ...
                                         decoration: InputDecoration(
                                             hintText: 'Write your questions and comments',
                                   ...
                                   Row(
                                     children: [
                                       Image.asset('images/Image (Single).png'),
                                       Text(
                                   ...
                                   Text(
                                     ...
                                     style: TextStyle(
                                         fontSize: 14,
                                         color: Color.fromRGBO(76, 89, 128, 1).withOpacity(0.5),
                                         fontWeight: FontWeight.w200),
                                   ),
                              ...
                              Container(
                                ...
                                child: ListTile(
                                  title: Text('US\$29',style: TextStyle(color: Colors.black,fontWeight: FontWeight.w600,fontSize: 20),),
