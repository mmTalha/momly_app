...
import 'package:momly_app/book_appointment_screens/all_doctors_screen.dart';
                          ...
                          child: InkWell(
                            onTap: (){
                              Navigator.push(
                                  context,
                                  CupertinoPageRoute(
                                      builder: (BuildContext context) => all_doctor_screen()));
                            },
                            child: Container(
                              padding: EdgeInsets.only(
                                left: 10,
                              ...
                              height: 60,
                              decoration: BoxDecoration(
                                  color: Color.fromRGBO(255, 153, 78, 1),
                                  borderRadius:
                                  ...
                                  Row(
                                    children: [
                                      Container(
                                          ...
                                          height: 40,
                                          child: Image.asset(
                                            'images/Pause (Circle).png',
                                            color:
                                                Color.fromRGBO(255, 153, 78, 1),
                                          )),
                                      SizedBox(
                                        width: 10,
                                      ),
