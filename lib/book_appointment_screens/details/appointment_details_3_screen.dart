...
import 'package:momly_app/book_appointment_screens/ask_Question_screen.dart';

class appointment_screen_3_screen extends StatelessWidget {
  const appointment_screen_3_screen({Key? key}) : super(key: key);
                  ...
                  children: [
                    ...
                    Center(
                      child: Container(
                        ...
                        height: 60,
                        decoration: BoxDecoration(
                            color: Color.fromRGBO(225, 216, 85, 1),
                            borderRadius: BorderRadius.all(Radius.circular(20))),
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                Container(
                                    ...
                                    width: 40,
                                    height: 40,
                                    child:Icon(Icons.star, color: Color.fromRGBO(225, 216, 85, 1),),),
                                SizedBox(width: 10,),
                                Text('Rate & Review',
                                    style: TextStyle(
                                        fontSize: 13,
