                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          children: [
                            Text("TOTAL SKILLS",style: TextStyle(fontSize: 12,color: Color(0xffE4DFFF)),),
                            Text("512",style: TextStyle(fontSize: 28,color: Colors.white,fontWeight: FontWeight.bold),),
                          ],
                        ),
                        Padding(
                        ...
                        Column(
                          children: [
                            ...
                            Text("4.4",style: TextStyle(fontSize: 28,color: Colors.white,fontWeight: FontWeight.bold),),
                          ],
                        )
                      ],
                    ),
                     ...
                     children: [
                      InkWell(
                         ...
                         child: Row(
                           mainAxisAlignment: MainAxisAlignment.spaceBetween,
                           children: [
                             Text("Skills",style: TextStyle(fontSize: 22,color: Color(0xff2D3142),fontWeight: FontWeight.bold),),
                             Container(
                                        height: 45,
                                        width: 100,
                                        decoration: BoxDecoration(
