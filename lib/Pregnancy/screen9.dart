          ...
          child: Container(
                  ...
                  child: Padding(
                   padding: const EdgeInsets.only(top:25),
                    child: Column(
                      children: [
                         Text("00:00",style: TextStyle(color: Color(0xff2D3142),fontSize: 48,fontWeight: FontWeight.w400),),
                      SizedBox(height: 40,),
                      InkWell(
                            ...
                            Center(
                             ...
                             Positioned(
                               ...
                               child: Container(
                                        ...
                                        child:Center(child: Text("I have\ncontraction",textAlign: TextAlign.center,style: TextStyle(fontSize: 24,color: Color(0xff707070)),)))
                                      ),
