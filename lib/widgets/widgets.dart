...
class supportmomly{
 Widget stakeprice(BuildContext context, price,sale ){
   return Stack(
                      ...
                      SizedBox(height: 10,),
                      Text(sale,  style: TextStyle(color: Colors.white,fontSize: 14,),),
                      SizedBox(height: 10,),
                                          ],
                                        ),
                                      ),
...
class signin{
  Widget sign( coolor,text, Color txtclr, size,wght,assets){
    ...
    SizedBox(width: 10,),
    Text(text,style: TextStyle(color: txtclr,fontSize: size,fontWeight: wght),)
        ],
      ),
    );
  }
  ...
  Widget Lisst(name,text){
    return Column(
      children: [
        ...
        Text(text,style: TextStyle(fontSize: 24,color: Color(0xff2D3142)),)
          ],
        ),
        Padding(
...
class skill{
  Widget skills(text,rate){
    return Row(
                       ...
                       children: [
                         Text(text,style: TextStyle(fontSize: 16,color: Color(0xff2D3142)),),
                         RatingBar.builder(
                           itemSize: 20,
   initialRating:rate,
   minRating: 1,
