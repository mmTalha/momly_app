                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Text("200.00",style: TextStyle(fontSize: 20,color: Colors.white) ,),
                            ],
                          ),
                       Padding(
                         padding: const EdgeInsets.only(top: 10,bottom: 10),
                         child: DottedLine( direction: Axis.vertical,dashColor: Colors.white,),
                       ),
                          Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text("Points",style: TextStyle(fontSize: 14,color: Colors.white) ,),
                              Text("1280.00",style: TextStyle(fontSize: 20,color: Colors.white) ,),
                            ],
                          ),
                        ],
                      ),
                         ...
                         Row(
                           children: [
                             ...
                             Column(
                               crossAxisAlignment: CrossAxisAlignment.start,
                               children: [
                                    Text("Richard",style: TextStyle(fontSize: 16,color: Color(0xff2D3142),fontWeight: FontWeight.w500) ,),
                                      SizedBox(height: 6,),
                                       Text("1mo, Male",style: TextStyle(fontSize: 14,color: Color(0xff4C5980)) ,),
                               ],
                             )
                           ],
                         ),
                         ...
                         Row(
                           children: [
                             ...
                             Column(
                               crossAxisAlignment: CrossAxisAlignment.start,
                               children: [
                                    Text("Christine",style: TextStyle(fontSize: 16,color: Color(0xff2D3142),fontWeight: FontWeight.w500) ,),
                                      SizedBox(height: 6,),
                                       Text("7yo, Female",style: TextStyle(fontSize: 14,color: Color(0xff4C5980)) ,),
                               ],
                             )
                           ],
                         ),
