       ...
       body: SingleChildScrollView(
        child: Column(
          children: [
                ...
                children: [Padding(
                    ...
                    child: Container(
                       width: double.infinity,
                              ...
                              child: Padding( padding: const EdgeInsets.only(left: 20,right: 20,top: 60),
                              child: Column(
            ...
            Padding(
                     padding: const EdgeInsets.only(left: 30,right: 20,top: 300,bottom: 50),
                     child: InkWell(
                    onTap: (){Navigator.push(
                      ...
                      width: double.infinity,
                        ...
                        color: Color(0xffF4F6FA)
                                     ...
                                     child:  Center(child: Text("REMOVE PROFILE",style: TextStyle(fontSize: 16,color: Color(0xff2D3142)) ,)),
                       ),
                     ),
                   ),
          ],
